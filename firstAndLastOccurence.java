...
public class firstAndLastOccurence {
    ...
    public static void main(String[] args) {
        ...
        int[] ans = new int[2];
        ans[0] = (a[lowerBound(a, target, 0, n - 1)] != target) ? - 1 : lowerBound(a, target, 0, n - 1);
        ans[1] = (a[UpperBound(a, target, 0, n - 1)] != target) ? - 1 : UpperBound(a, target, 0, n - 1) - 1;
    ...
    static int UpperBound(int[] a, int target, int start, int end){
